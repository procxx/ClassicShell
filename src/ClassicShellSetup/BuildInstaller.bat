...
SET CS_VERSION=3.6.6
SET CS_VERSION_STR=3_6_6
SET CS_VERSION_NUM=30606
SET CS_GUID32=1D1796C4-DCA7-4DD3-A29B-C0AAC1568C72
SET CS_GUID64=54E8F0F3-1827-4E6E-86C0-F6946E9CBE83
