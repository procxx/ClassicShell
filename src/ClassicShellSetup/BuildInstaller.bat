...
SET CS_VERSION=3.6.5
SET CS_VERSION_STR=3_6_5
SET CS_VERSION_NUM=30605
SET CS_GUID32=5012C3AD-9A0D-443d-9463-76E45A4655C9
SET CS_GUID64=CB00799C-0E4F-4fd1-A046-BD24321BCDFF
